...
"
" URLs above are for original, I've only made minor tweaks to make greys
" lighter
...
let s:darkgrey    = { "gui": "#64645e", "cterm": "237" }
let s:warmgrey    = { "gui": "#75715E", "cterm": "102" } " originally  59
...
call s:h("MatchParen",    { "fg": s:black,      "bg": s:purple,                           "format": "underline,bold" })
